...
class Home_Screen extends Component {
  ...
  render() {
    const chat = <GiftedChat messages={this.state.messages} isTyping={this.state.isTyping} onSend={Fire.send} user={this.user} />;

    if (Platform.OS === "android") {
      return (
        <KeyboardAvoidingView style={{ flex: 1 }} behavior="padding" keyboardVerticalOffset={90} enabled>
          {chat}
