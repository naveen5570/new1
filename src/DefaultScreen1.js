...
import {
  StyleSheet, Dimensions, Text, View, TouchableOpacity, Image, ActivityIndicator, FlatList, Alert, Platform, ScrollView, AsyncStorage
} from 'react-native';
...
class Home_Screen extends Component {
    ...
    return fetch(Globals.base_url + 'apptapp/Sugar/showsugar.php', {
      ...
      .then((responseJson) => {
        if (responseJson.result == 1) {
          console.log('test4=>' + responseJson)
          this.setState({
            loading: false,
  ...
  redirectaddmedi = () => {
    return fetch(Globals.base_url + 'apptapp/Sugar/RecommendedMedicine.php', {
      ...
      .then((response) => response.json())
      .then((responseJson) => {
        console.log('test1=>' + responseJson.result)
      ...
      <View style={styles.MainContainer}>
        <ScrollView>
          <View>
            ...
            <DataTable>
              <DataTable.Header>
                <DataTable.Title style={{ justifyContent: 'center', fontWeight: 'bold' }}>DATE</DataTable.Title>
                <DataTable.Title style={{ fontWeight: 'bold', justifyContent: 'center', }}>FASTING</DataTable.Title>
                <DataTable.Title style={{ fontWeight: 'bold', justifyContent: 'center', }}>PP1</DataTable.Title>
                <DataTable.Title style={{ fontWeight: 'bold', justifyContent: 'center', }}>PP2</DataTable.Title>
                <DataTable.Title style={{ fontWeight: 'bold', justifyContent: 'center', }}>PP3</DataTable.Title>
              </DataTable.Header>
        ...
        <View>
          <View style={styles.buttonContainer}>
            ...
            <GradientButton
              style={(User.firebase_id == '') ? { display: 'none' } : { marginTop: -10, }}
...
class Settings_Screen extends Component {
  ...
  redirectaddmedi = () => {
    return fetch(Globals.base_url + 'apptapp/Sugar/RecommendedMedicine.php', {
      ...
      .then((response) => response.json())
      .then((responseJson) => {
        console.log('test3=>' + responseJson.result)
        ...
        <ScrollView>
          <View>
            ...
            <DataTable>
              <DataTable.Header>
                <DataTable.Title style={{ justifyContent: 'center', fontWeight: 'bold' }} >DATE</DataTable.Title>
                <DataTable.Title style={{ justifyContent: 'center', fontWeight: 'bold' }} >BPMAX</DataTable.Title>
                <DataTable.Title style={{ justifyContent: 'center', fontWeight: 'bold' }} >BPMIN</DataTable.Title>
