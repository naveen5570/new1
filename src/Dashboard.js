...
import {
  StyleSheet, Text, View, TouchableOpacity, Image, Vibration, Dimensions, Platform, ActivityIndicator, SafeAreaView, Alert, AsyncStorage
} from 'react-native';
    ...
    return (
      ...
      <View style={{ flexDirection: 'row', flexWrap: 'wrap', marginHorizontal: 50, marginVertical: 10, top: 5 }}>
        ...
        <View style={{ flexDirection: 'row', marginLeft: 20 }}>
          ...
          <Text style={{ fontSize: 18, fontWeight: '300', marginLeft: 145, marginTop: 8, fontStyle: 'italic' }}>{User.name}</Text>
        ...
        <View style={{ flexDirection: 'row', marginHorizontal: 5 }} >
          <TouchableOpacity onPress={() => this.props.navigationProps.navigate('Profile')} >
            <Image
              ...
              style={{ width: 40, height: 40, borderRadius: 40 / 2, marginLeft: 5 }} />
          </TouchableOpacity>
        </View>
