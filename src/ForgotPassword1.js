...
class OTP extends React.Component {
  ...
  validateNumber = () => {
    ...
    fetch('https://2factor.in/API/V1/5b1a9203-8f78-11ea-9fa5-0200cd936042/SMS/' + mobile_number + '/AUTOGEN2/Reset Password')
      ...
      .then((responseJson) => {
        ...
        this.props.navigation.navigate('OTP', { session_id: this.state.session_id, mobile_number: this.state.mobile_number })
      })
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <TextInput
          style={{
            marginTop: 200, fontSize: 20, margin: 15,
