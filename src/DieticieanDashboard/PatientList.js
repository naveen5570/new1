...
class PatientList_Screen extends Component {
  ...
  renderItem = ({ item }) => {
    return (
      <TouchableOpacity onPress={() => this.props.navigation.navigate("PatientLogs", {
        ...
        <View style={styles.row}>
          ...
          <View>
            <View style={styles.nameContainer}>
              <Text style={styles.nameTxt} numberOfLines={1} ellipsizeMode="tail" onPress={() => this.props.navigation.navigate("PatientLogs", {
                patient_id: item.patient_id,
                name: item.name,
                batch_id: item.batch_id,
                phone: item.phone,
