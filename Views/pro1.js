      ...
      <View style={styles.container}>
        ...
        <TouchableOpacity onPress={() => this.props.navigation.navigate("SugarInput1")}>
          ...
          <View style={{
            ...
            <Text style={styles.GridViewInsideTextItemStyle} onPress={() => this.props.navigation.navigate("Dashboard2")} >Sugar Input</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => this.props.navigation.navigate("BPValue1")}>
          ...
          <View style={{
            ...
            <Text style={styles.GridViewInsideTextItemStyle} onPress={() => this.props.navigation.navigate("BPValue1")} >BP Input</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity onPress={(items) => this.props.navigation.navigate('MyChatp')}>
          <View style={{
            ...
            <Text style={styles.GridViewInsideTextItemStyle} onPress={() => this.props.navigation.navigate('ChatScreen2')} >Consult Doctor</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => this.props.navigation.navigate("addmedi1")}>
          <View style={{
            backgroundColor: '#F7F7F7',
            height: hp('21%'),
            margin: 5,
            ...
            />
            <Text style={styles.GridViewInsideTextItemStyle} onPress={() => this.props.navigation.navigate("addmedi2")} >Medicine</Text>
        ...
        <TouchableOpacity onPress={() => this.props.navigation.navigate("Membership1")}>
          <View style={{
            ...
            />
            <Text style={styles.GridViewInsideTextItemStyle} onPress={() => this.props.navigation.navigate("medicinerec")} >Membership</Text>
      ...
      <View style={styles.container}>
        <View style={styles.header}>
          <View style={styles.headerContent}>
            ...
            <Text style={styles.name}>Abhishek Sharma </Text>
            <Text style={styles.userInfo}>abhisheksharma@mail.com </Text>
